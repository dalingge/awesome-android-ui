...
public class FinePoiStarLoadingAnim extends View {
    ...
    public FinePoiStarLoadingAnim(Context context) {
        this(context, null);
    }

    public FinePoiStarLoadingAnim(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FinePoiStarLoadingAnim(Context context, AttributeSet attrs, int defStyleAttr) {
