...
public class BlockLoadingAnim extends View {
    ...
    public BlockLoadingAnim(Context context) {
        this(context, null);
    }

    public BlockLoadingAnim(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BlockLoadingAnim(Context context, AttributeSet attrs, int defStyleAttr) {
