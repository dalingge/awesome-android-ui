...
public class NewsLoadingAnim extends View {
    ...
    public NewsLoadingAnim(Context context) {
        this(context, null);
    }

    public NewsLoadingAnim(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewsLoadingAnim(Context context, AttributeSet attrs, int defStyleAttr) {
