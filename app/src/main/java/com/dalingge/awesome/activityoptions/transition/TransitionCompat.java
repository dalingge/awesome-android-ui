package com.dalingge.awesome.activityoptions.transition;
...
import com.dalingge.awesome.activityoptions.ActivityOptionsCompatICS;
import com.dalingge.awesome.activityoptions.anim.SceneFade;
import com.dalingge.awesome.activityoptions.anim.SceneScaleUp;
import com.dalingge.awesome.activityoptions.anim.ViewAnim;
import com.dalingge.awesome.activityoptions.util.Position;
...
public class TransitionCompat {
	...
	public static void startTransition(final Activity activity, final int layoutResId) {
		...
		case ActivityOptionsCompatICS.ANIM_THUMBNAIL_SCALE_UP:
			...
			mThumbnail = bundle.getParcelable(ActivityOptionsCompatICS.KEY_ANIM_THUMBNAIL);
			mIsInTheScreen = bundle.getBoolean(ActivityOptionsCompatICS.KEY_IS_IN_THE_SCREEN);
			mWidth = bundle.getInt(ActivityOptionsCompatICS.KEY_ANIM_WIDTH);
			mHeight = bundle.getInt(ActivityOptionsCompatICS.KEY_ANIM_HEIGHT);
			mStartX = bundle.getInt(ActivityOptionsCompatICS.KEY_ANIM_START_X);
