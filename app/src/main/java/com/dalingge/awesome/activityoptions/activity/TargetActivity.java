package com.dalingge.awesome.activityoptions.activity;
...
import com.dalingge.awesome.activityoptions.anim.ViewAnimationListenerAdapter;
import com.dalingge.awesome.activityoptions.transition.TransitionCompat;
import com.dalingge.awesome.activityoptions.transition.TransitionListenerAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TransitionCompat.addViewAnimListener(new ViewAnimationListenerAdapter() {
			...
			public void onViewAnimationStart(View view, Animator animator) {
				...
				if (MainOptionsActivity.isSceneAnim && TransitionCompat.isEnter) {
					MainOptionsActivity.handler.sendEmptyMessage(123);
				}
			}
			...
			public void onViewAnimationUpdate(View view, ValueAnimator valueAnimator, float progress) {
				...
				if (MainOptionsActivity.isSceneAnim && !TransitionCompat.isEnter
					...
					MainOptionsActivity.handler.sendEmptyMessage(321);
					isShowed = true;
				}
			}
